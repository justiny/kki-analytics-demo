...
const navigation = [
  ...
  },
  {
    ...
    current: false,
    children: [
      { name: 'Sessions', href: '#', label: 'Client' },
      { name: 'Clicks', href: '#', label: 'Client' },
      { name: 'Videos', href: '#', label: 'Client' },
      { name: 'Sessions', href: '#', label: 'Server' },
      { name: 'Clicks', href: '#', label: 'Server' },
      { name: 'Videos', href: '#', label: 'Server' },
    ],
  },
  {
    name: 'KKI Consumer',
