export const Tooltip = ({ children, title }: any) => (
  <div className='relative flex items-center group'>
    ...
    <div className='absolute hidden hover:block left-1/2 transform -translate-x-1/2 bottom-full mb-3 text-center p-2 text-xs text-white bg-black min-w-56 rounded-md shadow-lg group-hover:block'>
      {title}
